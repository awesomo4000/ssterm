...
class TestOutputProcessors(unittest.TestCase):
    ...
    def test_processor_raw(self):
        ...
        self.assertEqual(f("hello" + os.linesep + "world"), "hello" + 
                            os.linesep + "world")
        ...
        self.assertEqual(f("hello" + os.linesep + "world"), "hello" + 
                os.linesep + "world")
        self.assertEqual(f("helABlo"), "hel" + ssterm.Color_Codes[0] + "A" + 
                ssterm.Color_Code_Reset + ssterm.Color_Codes[1] + "B" + 
                ssterm.Color_Code_Reset + "lo")
    ...
    def test_processor_hexadecimal(self):
        ...
        if len(os.linesep) == 1:
            ...
            self.assertEqual(f(""), "")
            self.assertEqual(f("\xaa" + os.linesep + "\xbb"), "aa " + 
                              ("%02x " % ord(os.linesep)) + os.linesep + "bb ")

        f = ssterm.output_processor_hexadecimal([ord('A'), ord('B')])

        self.assertEqual(f(""), "")
        self.assertEqual(f("\xaa\xbb\xcc\xdd"), "aa bb cc dd ")
        self.assertEqual(f("AB\xee\xff"), ssterm.Color_Codes[0] + "41" + 
                                          ssterm.Color_Code_Reset + " " + 
                                          ssterm.Color_Codes[1] + "42" + 
                                          ssterm.Color_Code_Reset + " ee ff  ")
        self.assertEqual(f("\xee\xff\x00\x11\xee\xff\x00\x11"), 
                           "ee ff 00 11 ee ff 00 11" + os.linesep)
    ...
    def test_processor_split(self):
        ...
        self.assertEqual(f("IJKL"), 
                "\r41 42 43 44 45 46 47 48  49 4a 4b 4c              " + 
                "|ABCDEFGHIJKL    |")
        self.assertEqual(f("MNOP"), 
                "\r41 42 43 44 45 46 47 48  49 4a 4b 4c 4d 4e 4f 50  " + 
                "|ABCDEFGHIJKLMNOP|" + os.linesep)
        self.assertEqual(f("ABCD"), "\r41 42 43 44                                       |ABCD            |")
        ...
        self.assertEqual(f(""), "")
        self.assertEqual(f("0ABC"), "\r30 " + ssterm.Color_Codes[0] + 
                "41" + ssterm.Color_Code_Reset + " " + ssterm.Color_Codes[1] + 
                "42" + ssterm.Color_Code_Reset + 
                " 43                                       |0" + 
